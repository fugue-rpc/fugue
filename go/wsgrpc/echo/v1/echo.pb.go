...
const file_echo_v1_echo_proto_rawDesc = "" +
	...
	"\x03Msg\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value2\xaf\x01\n" +
	"\x04Echo\x12\"\n" +
	...
	"\bEchoBidi\x12\f.echo.v1.Msg\x1a\f.echo.v1.Msg(\x010\x01B)Z'github.com/grpcws/wsgrpc/echo/v1;echov1b\x06proto3"
...
var file_echo_v1_echo_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_echo_v1_echo_proto_depIdxs = []int32{
	...
	0, // 4: echo.v1.Echo.Echo:output_type -> echo.v1.Msg
	0, // 5: echo.v1.Echo.EchoStream:output_type -> echo.v1.Msg
	0, // 6: echo.v1.Echo.EchoCollect:output_type -> echo.v1.Msg
	0, // 7: echo.v1.Echo.EchoBidi:output_type -> echo.v1.Msg
